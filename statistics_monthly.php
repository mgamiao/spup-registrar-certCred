...
<div class="container-fluid">
  ...
  <div class="py-3 bordercolor mb-5" style="border:none;">
    ...
    <?php
        ...
        $diploma = count_by_forms_monthly("Diploma", $enterYear, $enterMonth);
        $tor = count_by_forms_monthly("Transcript of records", $enterYear, $enterMonth);
        $form137 = count_by_forms_monthly("Form137A", $enterYear, $enterMonth);
        $enrollment = count_by_forms_monthly("Certificate of Enrollment", $enterYear, $enterMonth);
        $grades = count_by_forms_monthly("Certificate of Grades", $enterYear, $enterMonth);
        $gwa = count_by_forms_monthly("Certificate of GWA", $enterYear, $enterMonth);
        $graduation = count_by_forms_monthly("Certificate of Graduation", $enterYear, $enterMonth);
        $english = count_by_forms_monthly("Certificate of English as Medium of Instruction", $enterYear, $enterMonth);
        $units = count_by_forms_monthly("Certificate of Units Earned", $enterYear, $enterMonth);
        $truecopy = count_by_forms_monthly("Certified True Copy of Documents (TOR/Diploma)", $enterYear, $enterMonth); 
        $coursedec = count_by_forms_monthly("Course Description", $enterYear, $enterMonth);
        $cav = count_by_forms_monthly("Certification, Authentication and Verification", $enterYear, $enterMonth);
        $transcredd = count_by_forms_monthly("Transfer credentials", $enterYear, $enterMonth);
