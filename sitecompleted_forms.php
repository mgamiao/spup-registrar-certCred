...
<?php if($status=="2" || $status=="3" || $status=="4" || $status=="5" && $school == "SCHOOL OF INFORMATION TECHNOLOGY AND ENGINEERING"){ ?>
    <tr>
        <td><?= $studnum?></td>
        ...
        &nbsp;&nbsp;
            <a href="sitecompleted_view_forms.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md">
            <span class="icon text-red-50">
