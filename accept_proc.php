<?php
	...
	$mail->isHTML(true);
	$mail->Body = "<h1>Hello " . $lastname . "</h1><br> $xdate . $xtime <h3> Your form was approved by the registrar office and now under review by your school dean</h3><br><br><br>Your reference number is: <b>". $unique."</b>";
