...
<?php if($status=="1" && $school=="SCHOOL OF BUSINESS, ACCOUNTANCY AND HOSPITALITY MANAGEMENT"){ ?>
    <tr>
        ...
        <td>
        &nbsp;&nbsp;
            <a href="sbahmdean_req_view_forms.php?id=<?= $id?>" class="btn btn-warning btn-icon-split btn-md">
