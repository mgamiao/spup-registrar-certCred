...
<?php if($status=="1" && $school=="SCHOOL OF ARTS, SCIENCES AND TEACHER EDUCATION"){ ?>
    <tr>
        <td><?= $studnum?></td>
        ...
        <td>
        &nbsp;&nbsp;
            <a href="sastedean_req_view_forms.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md">
