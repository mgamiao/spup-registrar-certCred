...
<div align="center" class="mb-5">
            <a href="sbahmdean_accept_proc.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md">
            ...
            <a href="sbahmdean_form_decline.php?id=<?= $id?>" class="btn btn-danger btn-icon-split btn-md">
            <span class="icon text-red-50">
        ...
        <a href="sbahmdean_req_forms.php" class="btn btn-warning btn-icon-split btn-md">
        <span class="icon text-red-50">
