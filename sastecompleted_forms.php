...
<?php if($status=="2" || $status=="3" || $status=="4" && $school == "SCHOOL OF ARTS, SCIENCES AND TEACHER EDUCATION"){ ?>
    <tr>
        <td><?= $studnum?></td>
        ...
        &nbsp;&nbsp;
            <a href="sastecompleted_view_forms.php?id=<?= $id?>" class="btn btn-warning btn-icon-split btn-md">
            <span class="icon text-red-50">
