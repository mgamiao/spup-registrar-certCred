...
<div class="card w-100 " style="border:none;">
    ...
    <?php
        ...
        $table_name = "forms";
        $column = "school";
        $condition = "SCHOOL OF ARTS, SCIENCES AND TEACHER EDUCATION";
        $get_userData = get_where_custom($table_name, $column, $condition);
...
<?php if($status=="2" || $status=="3" || $status=="4" || $status=="5" && $school == "SCHOOL OF ARTS, SCIENCES AND TEACHER EDUCATION"){ ?>
    <tr>
        <td><?= $studnum?></td>
        ...
        &nbsp;&nbsp;
            <a href="sastecompleted_view_forms.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md">
            <span class="icon text-red-50">
