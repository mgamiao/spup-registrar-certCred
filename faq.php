...
<div class="col-10 mt-5" style="margin-left:16%;">
        <div class="col-10">
            <div class="card shadow pb-8">
                    <button onclick="myFunction()"class="fullStats2">TYPE OF FORMS (CERTIFICATE/CREDENTIALS)</button>
                <div class="card-body pt-5" style="background-color:#F0F0F0; display:none" id="myDIV">
...
<div class="col-10" style="margin-left:16%;">
        <div class="col-10">
            <div class="card shadow">
                    <button onclick="myFunction2()"class="fullStats2">PROCEDURES</button>
                <div class="card-body pt-5" style="background-color:#F0F0F0; display:none" id="myDIV2">
...
<div class="col-10" style="margin-left:16%;">
        <div class="col-10">
            <div class="card shadow">
                    <button onclick="myFunction3()"class="fullStats2">MODE OF CLAIMING THE REQUESTED CREDENTIALS</button>
                <div class="card-body pt-5" style="background-color:#F0F0F0; display:none" id="myDIV3">
<div class="container">
  <table class="table table-striped">
    <thead>
...
<div class="col-10" style="margin-left:16%;">
        <div class="col-10">
            <div class="card shadow">
                    <button onclick="myFunction4()"class="fullStats2">DETAILS FOR ONLINE PAYMENT</button>
                <div class="card-body pt-5" style="background-color:#F0F0F0; display:none" id="myDIV4">
