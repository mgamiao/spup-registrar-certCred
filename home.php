<?php 
    ...
    $diploma = count_by_forms("Diploma", $yearNow);
    $tor = count_by_forms("Transcript of records", $yearNow);
    $form137 = count_by_forms("Form137A", $yearNow);
    $enrollment = count_by_forms("Certificate of Enrollment", $yearNow);
    $grades = count_by_forms("Certificate of Grades", $yearNow);
    $gwa = count_by_forms("Certificate of GWA", $yearNow);
    $graduation = count_by_forms("Certificate of Graduation", $yearNow);
    $english = count_by_forms("Certificate of English as Medium of Instruction", $yearNow);
    $units = count_by_forms("Certificate of Units Earned", $yearNow);
    $truecopy = count_by_forms("Certified True Copy of Documents (TOR/Diploma)", $yearNow); 
    $coursedec = count_by_forms("Course Description", $yearNow);
    $cav = count_by_forms("Certification, Authentication and Verification", $yearNow);
    $transcredd = count_by_forms("Transfer credentials", $yearNow);
...
// START AREA CHART DATA
    ...
    data: {
        ...
        label: "Requests",
        lineTension: 0.3,
        backgroundColor: ["rgb(4, 74, 51)", "rgb(204, 51, 0)", "rgb(11, 218, 149)","rgb(255, 153, 0)","rgb(255, 255, 0)",
        "rgb(51, 204, 51)","rgb(0, 0, 255)","rgb(153, 0, 204)","rgb(204, 0, 153)","rgb(255, 0, 0)","rgb(255, 153, 51)",
        "rgb(204, 255, 51)","rgb(0, 153, 255)",
        ],
