...
<br>
<div align="center">
            <a href="snahsdean_accept_proc.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md mb-5">
            ...
            <a href="snahsdean_form_decline.php?id=<?= $id?>" class="btn btn-danger btn-icon-split btn-md mb-5">
            <span class="icon text-red-50">
        ...
        <a href="snahsdean_req_forms.php" class="btn btn-warning btn-icon-split btn-md mb-5">
        <span class="icon text-red-50">
