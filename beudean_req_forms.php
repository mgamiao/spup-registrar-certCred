...
<div class="card w-100 " style="border:none;">
    ...
    <?php
        ...
        $table_name = "forms";
        $column = "school";
        $condition = "BASIC EDUCATION UNIT";
        $get_userData = get_where_custom($table_name, $column, $condition);
...
<?php if($status=="1" && $school=="BASIC EDUCATION UNIT"){ ?>
    <tr>
        <td><?= $studnum?></td>
        ...
        <td>
        &nbsp;&nbsp;
            <a href="beudean_req_view_forms.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md">
