...
<?php if($status=="2" || $status=="3" || $status=="4" || $status=="5" && $school == "SCHOOL OF NURSING AND ALLIED HEALTH SCIENCES"){ ?>
    <tr>
        <td><?= $studnum?></td>
        ...
        &nbsp;&nbsp;
            <a href="snahscompleted_view_forms.php?id=<?= $id?>" class="btn btn-success btn-icon-split btn-md">
            <span class="icon text-red-50">
